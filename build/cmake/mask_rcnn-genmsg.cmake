...
add_custom_target(_mask_rcnn_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mask_rcnn" "/home/mitch/catkin_ws/src/mask_rcnn/msg/Result.msg" "sensor_msgs/RegionOfInterest:std_msgs/Header:sensor_msgs/Image"
)

get_filename_component(_filename "/home/mitch/catkin_ws/src/mask_rcnn/srv/Detection.srv" NAME_WE)
add_custom_target(_mask_rcnn_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mask_rcnn" "/home/mitch/catkin_ws/src/mask_rcnn/srv/Detection.srv" "sensor_msgs/RegionOfInterest:sensor_msgs/Image:std_msgs/Header:mask_rcnn/Result"
)
...
_generate_srv_cpp(mask_rcnn
  ...
  "${MSG_I_FLAGS}"
  "/opt/ros/noetic/share/sensor_msgs/cmake/../msg/RegionOfInterest.msg;/opt/ros/noetic/share/sensor_msgs/cmake/../msg/Image.msg;/opt/ros/noetic/share/std_msgs/cmake/../msg/Header.msg;/home/mitch/catkin_ws/src/mask_rcnn/msg/Result.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/mask_rcnn
)
