...
(cl:defmethod cl:initialize-instance :after ((m <Result>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Result)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mask_rcnn-msg:<Result> is deprecated: use mask_rcnn-msg:Result instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Result>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_rcnn-msg:header-val is deprecated.  Use mask_rcnn-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'class_names-val :lambda-list '(m))
(cl:defmethod class_names-val ((m <Result>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_rcnn-msg:class_names-val is deprecated.  Use mask_rcnn-msg:class_names instead.")
  (class_names m))

(cl:ensure-generic-function 'masks-val :lambda-list '(m))
(cl:defmethod masks-val ((m <Result>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mask_rcnn-msg:masks-val is deprecated.  Use mask_rcnn-msg:masks instead.")
  (masks m))
